...
# ============== 추가: 분리수거 감지 모듈 import ==============
from recycling_detection import RecyclingDetection
# ===========================================================
...
def run(
    ...
    # ============== 추가: 분리수거 감지 객체 생성 ==============
    recycling_detector = RecyclingDetection(names)
    # =========================================================
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    # ============== 추가: 검출된 클래스 표시 ==============
                    detected[int(cls)] = 1
                    recycling_detector.update_confidence(names[int(cls)], float(conf))
                    # ====================================================
            ...
            # ============== 추가: 분리수거 감지 및 서버 전송 ==============
            recycling_detector.add(names, detected, save_dir, im0)
            # =============================================================
